...
import { IUIConfig, IConfigItem } from "@/types";

interface IUIConfigurationModalProps {
  isOpen: boolean;
  onClose: () => void;
  UIConfig: IUIConfig;
...
const UIConfigurationModal = ({
  ...
  handleUpdateUiHide,
  toggleLiveScreen,
}: IUIConfigurationModalProps) => {
  const uiConfigItems: IConfigItem[] = [
    {
